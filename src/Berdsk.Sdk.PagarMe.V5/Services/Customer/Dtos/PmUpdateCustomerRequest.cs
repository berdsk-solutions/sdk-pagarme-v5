...
namespace Berdsk.Sdk.PagarMe.V5.Services.Customer.Dtos
{
    ...
    /// </summary>
    public class PmUpdateCustomerRequest
    {
        /// <summary>
        ...
        /// <summary>
        ///     CPF, CNPJ ou PASSAPORTE do cliente. Max: 16 caracteres para CPF e CNPJ e Max: 50 caracteres para PASSAPORTE
        /// </summary>
        ...
        /// <summary>
        ///     Endereço do cliente. Saiba mais sobre endereços: https://docs.pagar.me/reference/endereços
        /// </summary>
