...
namespace Berdsk.Sdk.PagarMe.V5.Services.Transfers.Dtos
{
    ...
    {
        /// <summary>
        ///     Valor, em centavos, a ser transferido para uma determinada conta bancária (valor precisa estar entre 1 e 2147483647)
        /// </summary>
        ...
        /// <summary>
        ///     Você pode passar dados adicionais na criação da transferência para facilitar uma futura análise de dados por seus sistemas.
        /// </summary>
