# Criar pedido multimeios

Neste caso voc̻ inclui mais de um objeto na cole̤̣o de **payments**. Desta maneira voc̻ pode realizar pedido com
diversos cart̵es ou combinando diferentes meios de pagamento.
