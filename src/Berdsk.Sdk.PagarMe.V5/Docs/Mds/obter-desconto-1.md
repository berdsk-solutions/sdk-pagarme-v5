...
AtravÃ©s dos identificadores da assinatura (`subscription_id`) e do desconto associado (`discount_id`) Ã© possÃ­vel
recuperar as informações do desconto.
...
```json
{
  ...
  "paths": {
    "/subscriptions/{subscription_id}/discounts/{discount_id}": {
      "get": {
        "summary": "Obter desconto",
        "description": "AtravÃ©s dos identificadores da assinatura (`subscription_id`) e do desconto associado (`discount_id`) Ã© possÃ­vel recuperar as informações do desconto.",
        "operationId": "obter-desconto-1",
        "parameters": [
          {
