...
Com o verbo HTTP DELETE, atravÃ©s dos identificadores do uso (`usage_id`), do item (`subscription_item_id`) a da
assinatura associada (`subscription_id`), Ã© possÃ­vel excluir o uso do item de uma assinatura.
...
```json
{
  ...
  "paths": {
    "/subscriptions/{subscription_id}/items/{item_id}/usages/{usage_id}": {
      "delete": {
        "summary": "Remover uso",
        "description": "Com o verbo HTTP DELETE, atravÃ©s dos identificadores do uso (`usage_id`), do item (`subscription_item_id`) a da assinatura associada (`subscription_id`), Ã© possÃ­vel excluir o uso do item de uma assinatura.",
        "operationId": "remover-uso",
        "parameters": [
          {
          ...
          },
          {
            "name": "usage_id",
            "in": "path",
            "description": "CÃ³digo do uso.<br>Formato: `usage_XXXXXXXXXXXXXXXX`.",
            "schema": {
              "type": "string"
            },
            "required": true
