...
Com o verbo _HTTP DELETE_, atravÃ©s dos identificadores do incremento (`increment_id`) e da assinatura associada (
`subscription_id`) Ã© possÃ­vel remover um incremento do plano.
...
```json
{
  ...
  "paths": {
    "/subscriptions/{subscription_id}/increments/{increment_id}": {
      "delete": {
        "summary": "Remover incremento",
        "description": "Com o verbo _HTTP DELETE_, atravÃ©s dos identificadores do incremento (`increment_id`) e da assinatura associada (`subscription_id`) Ã© possÃ­vel remover um incremento do plano.",
        "operationId": "remover-incremento-1",
        "parameters": [
          {
