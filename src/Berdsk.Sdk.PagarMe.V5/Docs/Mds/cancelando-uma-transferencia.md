# Cancelando uma transferÃªncia

Cancela uma transferÃªncia previamente realizada. SÃ³ Ã© possÃ­vel cancelar transferÃªncias com status **pending_transfer**.
...
```json
{
  ...
  "paths": {
    "/transfers/{transfer_id}/cancel": {
      "post": {
        "summary": "Cancelando uma transferÃªncia",
        "description": "Cancela uma transferÃªncia previamente realizada. SÃ³ Ã© possÃ­vel cancelar transferÃªncias com status **pending_transfer**.",
        "operationId": "cancelando-uma-transferÃªncia",
        "parameters": [
          {
            "name": "transfer_id",
            "in": "path",
            "description": "ID da transferÃªncia a ser cancelada",
            "schema": {
              "type": "string"
            },
            "required": true
