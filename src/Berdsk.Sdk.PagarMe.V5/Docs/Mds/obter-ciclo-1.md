...
AtravÃ©s do identificador do ciclo (`cycle_id`) Ã© possÃ­vel recuperar as informaÃ§Ã£o do ciclo de uma assinatura.
...
```json
{
  ...
  "paths": {
    "/subscriptions/{subscription_id}/cycles/{cycle_id}": {
      "get": {
        "summary": "Obter ciclo",
        "description": "AtravÃ©s do identificador do ciclo (`cycle_id`) Ã© possÃ­vel recuperar as informaÃ§Ã£o do ciclo de uma assinatura.",
        "operationId": "obter-ciclo-1",
        "parameters": [
          {
