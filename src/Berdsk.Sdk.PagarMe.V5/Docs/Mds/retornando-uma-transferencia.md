# Retornando uma transferÃªncia

Retorna os dados de uma transferÃªncia em especÃ­fico de sua conta.
...
```json
{
  ...
  "paths": {
    "/transfers/{transfer_id}": {
      "get": {
        "summary": "Retornando uma transferÃªncia",
        "description": "Retorna os dados de uma transferÃªncia em especÃ­fico de sua conta.",
        "operationId": "retornando-uma-transferÃªncia",
        "parameters": [
          {
            "name": "transfer_id",
            "in": "path",
            "description": "ID da transferÃªncia desejada",
            "schema": {
              "type": "string"
            },
            "required": true
