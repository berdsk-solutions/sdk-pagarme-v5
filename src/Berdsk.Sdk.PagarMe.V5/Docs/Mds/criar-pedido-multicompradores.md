...
Neste caso vocÃª pode incluir um cliente (`customer`) dentro do nÃ³ de pagamento (`payment`). Caso um nÃ³ `payment` nÃ£o
possua um nÃ³ `customer` dentro, assumiremos que o pagador dele Ã© o mesmo `customer` do pedido.

> ðŸš§ MULTIMEIOS DEVEM TER SEUS VALORES DISCRIMINADOS SEPARADAMENTE
>
> Portanto, cada objeto dentro `payments` deverÃ¡ ter seu prÃ³prio valor, bastando para isso incluir a propriedade
`amount` com o valor correspondente ao de cada um dos meios de pagamento escolhidos. A resposta conterÃ¡ alÃ©m dos valores
> separados, um campo `amount` com a soma do todos os meios utilizados, que representa o valor total do pedido.
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "metadata": {
                    "type": "string",
                    "description": "Objeto chave/valor utilizado para armazenar informaÃ§Ãµes adicionais sobre o pedido."
                  }
                }
              },
              "examples": {
